...
<body>
                    ...
                    <div class="wrap d-md-flex">
                        <div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
                            <div class="text w-100">
                                <h2>
                                    Dashboard Aplikasi Absensi</h2>
                                <p>PT. LINY JAYA INFORMATIKA</p>
                            </div>
                        </div>
                        <div class="login-wrap p-4 p-lg-5">
                            ...
                            <form action="{{ route('login') }}" method="POST" class="signin-form">
                                ...
                                <div class="form-group mb-3">
                                    <label class="label" for="name">Nomor HP</label>
                                    <input type="text" class="form-control @error('hp') is-invalid @enderror"
                                        placeholder="nomor hp" value="{{ old('hp') }}" name="hp">
                                    @error('hp')
    ...
    <script src="{{ asset('template-admin') }}/js/popper.js"></script>
